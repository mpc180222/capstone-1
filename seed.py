...
first_post = Post(user_id = user1m.id, media='https://www.youtube.com/embed/lNdOcFaVkL4', caption ='After Waking From Two-Year Coma, Woman Names Brother As Her Attacker', timestamp = '20220728 10:05:09 AM')
second_post = Post(user_id = user1m.id, media='https://www.youtube.com/embed/a1Ld8ONWCE8', caption ='Bannon Threatens To Go Medieval In Contempt Trial, Judge Clearly Doesnt Care', timestamp = '20220728 10:07:09 AM')
third_post = Post(user_id = user1m.id, media='https://www.youtube.com/embed/iExzgxmE9OE', caption ='Forest fires rage across Europe as heatwave tightens its grip', timestamp = '20220728 10:12:09 AM')
fourth_post = Post(user_id = user1m.id, media='https://www.youtube.com/embed/wmP57dj7L9A', caption ='Soaring rents price out some Canadians', timestamp = '20220728 10:25:09 AM')
fifth_post = Post(user_id = user1m.id, media='https://www.youtube.com/embed/d_wRcj0MCro', caption ='Wildfires forcing evacuations in northern Manitoba and B.C.', timestamp = '20220728 10:35:09 AM')
sixth_post = Post(user_id = user1f.id, media='https://www.youtube.com/embed/C-qsnDLdq68', caption ='Whats behind the shortage of family doctors in Canada?', timestamp = '20220712 10:05:09 AM')
seventh_post = Post(user_id = user1f.id, media='https://www.youtube.com/embed/ugM3i9RH_pM', caption ='Wildfires prompt evacuation of First Nation in northern Manitoba', timestamp = '20220728 11:05:09 AM')
eighth_post = Post(user_id = user1f.id, media='https://www.youtube.com/embed/oepZJW6A4tc', caption ='Why this Ottawa woman is learning Indigenous sign language to connect with her culture', timestamp = '20220728 11:15:09 AM')
ninth_post = Post(user_id = user2m.id, media='https://www.youtube.com/embed/g-X67dm6lAY', caption ='Fallout continues over Ottawas release of turbines', timestamp = '20220728 11:25:09 AM')
tenth_post = Post(user_id = user2f.id, media='https://www.youtube.com/embed/yV78etXN96U', caption ='Partner of N.S. mass shooter testifies in person for the first time', timestamp = '20220728 11:33:09 AM')
older_post = Post(user_id = user1f.id, media ='https://www.youtube.com/embed/Dh5C-F5hSXQ', caption = 'This is more than a week old', timestamp= '20120618 10:34:09 AM')
older_post2 = Post(user_id = user1m.id, media ='https://www.youtube.com/embed/Dh5C-F5hSXQ', caption = 'This is also more than a week old', timestamp= '20120618 10:34:09 AM')
...
timestamp = '20220728 11:45:09 AM')
picture_post2 = Post(user_id = user2m.id, media = 'https://images.unsplash.com/photo-1658893769271-c2461cab05b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80', caption = 'Some great raspberries!', timestamp = '20220728 12:33:09 PM' )
picture_post3 = Post(user_id = user1f.id, media = 'https://images.unsplash.com/photo-1658947051795-1bbc7e132847?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80', caption = 'Some pottery!', timestamp = '20220728 12:15:09 PM' )
picture_post4 = Post(user_id = user2f.id, media = 'https://images.unsplash.com/photo-1658959601004-89911c69089f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80', caption = 'A picture of my dog!', timestamp = '20220728 12:45:09 PM' )
